...
REM cmd /k gradlew.bat :application:test -PisProduction=true --tests "sk.crawler.ibouz.setkaihou.SetKaihou" -i
cmd /k %ABS_PATH%/gradlew.bat :application:test -Denv=IS_PROD --tests "sk.crawler.ibouz.setkaihou.SetKaihou" -i
